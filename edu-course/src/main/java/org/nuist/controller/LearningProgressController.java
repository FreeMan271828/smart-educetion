...
import org.nuist.client.LearningProgressClient;
...
public class LearningProgressController implements LearningProgressClient {
     ...
     */
    @PostMapping("/update")
    public ResponseEntity<Long> updateLearningProgress(@RequestBody LearningProgressBO progress) {
    ...
    public ResponseEntity<Integer> batchUpdateLearningProgress(
